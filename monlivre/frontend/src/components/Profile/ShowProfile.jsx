            ...
            <div className="col">
              <div className="card-profile-stats d-flex justify-content-center mt-md-5">
                <div>
                  ...
                  <span className="description text-white">Friends</span>
                </div>
                <div>
                  <span className="heading">10</span>
                  <span className="description text-white">Photos</span>
                </div>
                <div>
                  <span className="heading">89</span>
                  <span className="description text-white">Comments</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="card-header bg-white border-0">
          <div className="row align-items-center">
            ...
            <div className="col-4 text-right">
              <a href="#!" className="btn btn-sm btn-outline-primary">Settings</a>
            </div>
          </div>
        </div>
        <div className="card-body bg-white">
          <form>
            <h6 className="heading-small text-muted mb-4 text-white ">User information</h6>
            <div className="pl-lg-4">
              <div className="row">
                <div className="col-lg-6">
                  <div className="form-group">
                    <label className="form-control-label text-white" htmlFor="input-username">Username</label>
                ...
                <div className="col-lg-6">
                  <div className="form-group">
                    <label className="form-control-label text-white" htmlFor="input-email">Email address</label>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="form-group">
                    <label className="form-control-label text-white" htmlFor="input-first-name">First name</label>
                ...
                <div className="col-lg-6">
                  <div className="form-group">
                    <label className="form-control-label text-white" htmlFor="input-last-name">Last name</label>
            ...
            <hr className="my-4" />
            {/* Address */}
            <h6 className="heading-small text-muted mb-4 text-white">Contact information</h6>
            <div className="pl-lg-4">
              <div className="row">
                <div className="col-md-12">
                  <div className="form-group">
                    <label className="form-control-label text-white" htmlFor="input-address">Address</label>
              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="form-group">
                    <label className="form-control-label text-white" htmlFor="input-city">City</label>
                    <input type="text" id="input-city" className="form-control form-control-alternative" placeholder="City" defaultValue="New York" />
                  </div>
                </div>
                <div className="col-lg-4">
                  <div className="form-group">
                    <label className="form-control-label text-white" htmlFor="input-country">Country</label>
                ...
                <div className="col-lg-4">
                  <div className="form-group">
                    <label className="form-control-label text-white" htmlFor="input-country">Postal code</label>
            ...
            <hr className="my-4" />
            {/* Description */}
            <h6 className="heading-small text-muted mb-4 text-white">About me</h6>
            <div className="pl-lg-4">
              <div className="form-group">
    ...
    <div className="row align-items-center justify-content-xl-between">
      <div className="col-xl-6">
        <div className="copyright text-center text-xl-left text-muted">
          © 2022<a href="https://www.creative-tim.com" className="font-weight-bold ml-1" target="_blank">MonLivre</a>
        </div>
      </div>
      <div className="col-xl-6">
